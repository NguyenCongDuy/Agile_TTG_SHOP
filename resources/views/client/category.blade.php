    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4 mb-lg-0">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('client.category', $category->slug) }}" method="GET">
                        <!-- Price Range -->
                        <div class="mb-3">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h5 class="mb-0">Danh mục liên quan</h5>
                </div>
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        @foreach(\App\Models\Category::where('id', '!=', $category->id)->take(5)->get() as $relatedCategory)
                        <li class="list-group-item px-0">
                            <a href="{{ route('client.category', $relatedCategory->slug) }}" class="text-decoration-none">
        ...
        <div class="col-lg-9">
            ...
            @if($products->isEmpty())
                <div class="alert alert-info">
                    <i class="bi bi-info-circle me-2"></i>Không có sản phẩm nào trong danh mục này.
                </div>
            @else
                <div class="row g-4">
